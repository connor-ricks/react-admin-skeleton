...
export class ServerActionResponse {
   ...
   * @param {string | undefined} [params.message] - An optional message associated with the response.
   * @param {Payload | undefined} [params.payload] - An optional payload associated with the response.
   ...
   * @template Payload
   * @param {Object} [params] - The parameters for the failure response.
   * @param {string | undefined} [params.message] - An optional message associated with the response.
   * @param {Payload | undefined} [params.payload] - An optional payload associated with the response.
   * @returns {ServerActionResponse<Payload>}
   */
